  ...
  return (
    <div>
      ...
      >
        {/* slide 1  */}
        <SwiperSlide>
          <div className="flex flex-col md:flex-row justify-center min-h-[84vh] items-center cursor-pointer rounded-md pb-10">
        ...
        {/* slider 2  */}
        <SwiperSlide>
          <div className="flex flex-col md:flex-row justify-center min-h-[84vh] items-center cursor-pointer rounded-md">
            <figure className=" px-3 md:pl-36 py-10">
              <img
